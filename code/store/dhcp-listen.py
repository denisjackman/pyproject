...
while True:
    ...
    # if we have information in friendly_names about either,
    # overwrite the say_hostname
    ...
    print("{}: {} ({}) has joined".format(current_time,
                                          device.name,
                                          device.mac))
