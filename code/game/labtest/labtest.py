...
def create_surface(surface_colour, surface_size):
    ...
    '''
    result_surface = pygame.Surface(surface_size)  # Create empty pygame surface
    result_surface.fill(surface_colour)              # Fill the background white color (red,green,blue)
    result_surface = result_surface.convert()       # Convert Surface to make blitting faster
