'''
This module contains the ExampleHex class which is a subclass of HexTile.
It is used to demonstrate how to create a subclass of HexTile and
...
class ExampleHex(hx.HexTile):
    '''
    A subclass of HexTile that is used to demonstrate
    how to create a subclass of HexTile and how to use it in a game.'''
    ...
    def get_draw_position(self):
        """
        Get the location to draw this hex so that the center of the
        hex is at `self.position`.
