...
fontObj4 = pygame.font.Font('y:/Resources/Fonts/halfelven.ttf',32)
...
def load_image(name,colorkey=None):
    '''
        load image
    '''
    fullname=os.path.join('y:/Resources/images',name)
    try:
...
def load_sound(name):
    ...
    if not pygame.mixer:
        return NoneSound()
    fullname = os.path.join('y:/Resources/sounds', name)
    try:
