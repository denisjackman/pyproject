...
def variousdemo():
    ...
    print(f'[-] score rating - old 1200 playing 1200 and winning : {newRating(1200, 1200, "w")}')
    print(f'[-] score rating - old 1200 playing 1200 and losing  : {newRating(1200, 1200, "Loss")}')
    print(f'[-] score rating - old 1216 playing 1184 and winning : {newRating(1216, 1184, "Win")}')
    print(f'[-] age based on 2/3/2023                            : {ageCalculator(1965, 3, 2)}')
    print(f'[-] password genertator (18 characters long)         : {passwordgenerator(18)}')
