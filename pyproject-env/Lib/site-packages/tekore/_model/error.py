...
class PlayerErrorReason(Enum):
    ...
    NOT_PLAYING_TRACK = 'The command requires that ' \
                        'a track is currently playing.'
    NOT_PLAYING_CONTEXT = 'The command requires that ' \
                          'a context is currently playing.'
    ENDLESS_CONTEXT = 'The shuffle command cannot be applied ' \
                      'on an endless context.'
    ...
    VOLUME_CONTROL_DISALLOW = 'Not possible to remote control ' \
                              'the device’s volume.'
